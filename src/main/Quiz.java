...
public class Quiz extends Textarena {
	...
	public static boolean quiz () {
		...
		Help.p(hhero1.getpName()+"du hast "+maxtime /1000+" Sekunden. Es geht los in...");
		Help.warte(2000);
		Help.punkte(3,1000);
		fragenDB();
		if (gewonnen) {
		...
		Help.p("Falsch! "+hhero2.getpName()+" darf den ersten Angriff machen!");
		Help.warte(2800);
		return false;
	}
	...
	public static void fragenDB() {
		...
		if(x==0) {
			Help.p(hhero1.getpName()+", Wie viele Kilometer ist der Umfang der Erde gross?"); Help.p();
			...
			Help.p(hhero1.getpName()+", Wie viel Liter verbraucht man beim Duschen?"); Help.p();
			...
			Help.p("RECHENAUFGABE FUER "+hhero1.getpName()+" !!!!!");
			int y = (int) (2+Math.random()*10); int z = (int) (2+Math.random()*10);
			Help.p(hhero1.getpName()+", Was ist "+y+" * "+z+" ?"); Help.p();
			...
			Help.p(hhero1.getpName()+", Was ist am schlechtesten?"); Help.p();
