...
public class SpellDB {
    ...
    public static double LAZOR(Hero h, Hero g) {
        ...
        if (g.getClassS() == Classes.SHELDON) {
            ...
            System.err.println("* LAZ0000R BEEAAM !!! trifft die Fl�gel des Drachen. Er f�llt zu Boden! *");
            g.ausre("a", 0.2);
            g.ausre("g", 0.2);
            ...
            System.err.println("* LAZ00000RBEAM DES TODES !!! ... trifft den Zwerg! Ein zischen ist zu h�ren. Es scheint ihm nicht sehr zu schaden. *");
            return 10 + g.getL() * (malor(h.getM(), 1000));
        } else if (g.getClassS() == Classes.ORK) {
            System.err.println("* LAZ000R BEAAAM zerreist die Haut des Orks! Der Ork schreit grausam wegen den Schmerzen. Aus Mitleid h�rst du nach 4 Sekunden auf. *");
