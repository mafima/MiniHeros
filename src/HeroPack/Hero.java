...
public class Hero {
	 ...
	 * 
	 */
	private double life = 3; // LIFECHANGEpackage HeroPack;
...
public class Hero {
	...
	public void ausre(String choose, double change) {
		...
		if (choose.equalsIgnoreCase("a")) {
			...
			neu = this.hangriff; if (neu==0) return;
			System.out.println();
			if (change < 1) {
				System.out.print("[---]");
			} else {
		...
		if (choose.equalsIgnoreCase("g")) {
			this.hgeschick = this.hgeschick * change;
			neu = this.hgeschick; if (neu==0) return;
			System.out.println();
			if (change < 1) {
				System.out.print("[---]");
			} else {
		...
		if (choose.equalsIgnoreCase("h")) {
			this.hhirn = this.hhirn * change;
			neu = this.hhirn; if (neu==0) return;
			System.out.println();
			if (change < 1) {
				System.out.print("[---]");
			} else {
		...
		if (choose.equalsIgnoreCase("m")) {
			...
			neu = this.hmagie; if (neu==0) return;
			System.out.println();
			if (change < 1) {
				System.out.print("[---]");
			} else {
		...
		if (choose.equalsIgnoreCase("leben")) {
			...
			neu = this.hleben; if (neu==0) return;
			System.out.println();
			if (change < 1) {
				System.out.print("[---]");
			} else {
