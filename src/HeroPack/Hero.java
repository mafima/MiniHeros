...
public class Hero {
    ...
    public double get(String choose) {
        ...
        if (choose.equalsIgnoreCase("l")) {
            return hleben;
        }
        if (choose.equalsIgnoreCase("max")) {
            return maxleben;
        }
    ...
    public void addDefaultValues(Classes heroClass) {
        ...
        if (heroClass == Classes.MENSCH) {
            ...
            System.out.println(MiniHeros.prefix + getpName() + "ruft: Mit einem starkem Bart ist alles m�glich!");
        } else if (heroClass == Classes.GNOM) {
            createHero(20, 30, 250, 400, 200, 1.1, Values.POWERgnom);
            System.out.println(MiniHeros.prefix + getpName() + "sagt: H�rt auf zu lachen! Ich bin nicht klein!");
            ...
            System.out.println();
            for (int i = 0; i < 3; i++) {
                System.out.print("~ M�GEN DIE FLAMMEN SIE FOLTERN! ~");
            }
            System.out.println();
            System.out.println(MiniHeros.prefix + ".=======================================. ~~~~~~~~~~~~~~           ~~~~~~~ ~  ~     ");
            System.out.println(MiniHeros.prefix + "|   -   -   -   -   -   -   -   -   -   | ~~~~~~~~~~~~~~~~~~~  ~~~~~~~~~~~ ~ ~~  ~     ~");
            ...
            System.out.println();
            for (int i = 0; i < 3; i++) {
                System.out.print(" ~| M�GE DAS EIS SIE VERNICHTEN! |~ ");
            }
            System.out.println(MiniHeros.prefix + ".======================================. ~~~~~~~~~~~~~~           ~~~~~~~ ~  ~     ");
            System.out.println(MiniHeros.prefix + "|   *   *   *   *   *   *   *   *   *  | ~~~~~~~~~~~~~~~~~~~  ~~~~~~~~~~~ ~ ~~  ~     ~");
            ...
            addSpells("NEIN", "ICHSAGENEIN", "�HNEIN", "NEINNEINNEIN");
        } else if (heroClass == Classes.JAHEIT) {
            createHero(1000, 8000, 100, 100, 50000, 2, Values.POWERjaheit);
            addSpells("JA", "ICHSAGEIMMERJA", "JAKLAR", "JANAT���RLICH");
